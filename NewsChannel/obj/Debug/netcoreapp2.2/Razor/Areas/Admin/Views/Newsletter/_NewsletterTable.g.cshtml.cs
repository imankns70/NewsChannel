#pragma checksum "D:\projects\NewsChannel\NewsChannel\Areas\Admin\Views\Newsletter\_NewsletterTable.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "dfcbd06c79958838e51217ac618254eb728d8fd6"
// <auto-generated/>
...
namespace AspNetCore
{
    ...
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"dfcbd06c79958838e51217ac618254eb728d8fd6", @"/Areas/Admin/Views/Newsletter/_NewsletterTable.cshtml")]
...
#line 3 "D:\projects\NewsChannel\NewsChannel\Areas\Admin\Views\Newsletter\_NewsletterTable.cshtml"
                                                                                   Write(Url.Action("DeleteGroup","Newsletter"));

#line default
#line hidden
            EndContext();
            BeginContext(153, 1944, true);
            WriteLiteral(@""">
...
#line 70 "D:\projects\NewsChannel\NewsChannel\Areas\Admin\Views\Newsletter\_NewsletterTable.cshtml"
                                                                                              Write(Url.Action("Delete", "Newsletter"));

#line default
#line hidden
            EndContext();
            BeginContext(2132, 2868, true);
            WriteLiteral(@"?id=' +
             row.Id +
             ' title=""حذف"">',
    ...
    function isActiveFormatter(value, row, index) {
       ...
       if (row.IsActive) {
        ...
        return [
            '<label class=""custom-toggle mb-0""> <input type=""checkbox"" value=""' +
            row.Id +
            '"" ' +
            attr +
            ' /><span class=""custom-toggle-slider rounded-circle""></span></label>'
        ].join('');
    }
            ...
            WriteLiteral(@" height: 600,
                ...
                columns: [
                    ...
                    [{
                        ...
                        title: 'ایمیل',
                        sortable: true,
                        footerFormatter: tota");
            WriteLiteral(@"lNameFormatter,
                    },{
                        field: 'تاریخ عضویت',
                        title: 'تاریخ عضویت',
                        sortable: true,
